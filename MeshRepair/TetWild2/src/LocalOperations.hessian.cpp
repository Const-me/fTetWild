...
void floatTetWild::AMIPS_hessian_v2( const std::array<double, 12>& arr, Matrix3& result_0 )
{
	...
	const __m256d t10 = _mm256_sub_pd( _mm256_mul_pd( m5, v1 ), _mm256_mul_pd( m5, v2 ) );
	STORE( t10 );
	...
	const double helper_67 = v2_x + v1_x;
	const double helper_68 = ( -3 * v0_x + helper_67 + v3_x ) * 0.5;
	const double helper_69 = ( v0_x + helper_67 - 3 * v3_x ) * 0.5;
	const double helper_70 = ( -3 * v2_x + v0_x + v1_x + v3_x ) * 0.5;
	const double helper_71 = ( v2_x + v0_x - 3 * v1_x + v3_x ) * 0.5;
	const double helper_72 = v1_y + v2_y;
	const double helper_73 = ( -3 * v0_y + v3_y + helper_72 ) * 0.5;
	const double helper_74 = ( v0_y - 3 * v3_y + helper_72 ) * 0.5;
	const double helper_75 = ( v0_y + v1_y - 3 * v2_y + v3_y ) * 0.5;
	const double helper_76 = ( v0_y - 3 * v1_y + v2_y + v3_y ) * 0.5;
	const double helper_77 = v1_z + v2_z;
	const double helper_78 = ( -3 * v0_z + v3_z + helper_77 ) * 0.5;
	const double helper_79 = ( v0_z - 3 * v3_z + helper_77 ) * 0.5;
	const double helper_80 = ( v0_z + v3_z + v1_z - 3 * v2_z ) * 0.5;
	const double helper_81 = ( v0_z + v3_z - 3 * v1_z + v2_z ) * 0.5;

	const double helper_82 = v0_z * helper_78 + v0_y * helper_73 + v1_y * helper_76 + v2_y * helper_75 + v3_y * helper_74 + v3_z * helper_79 +
							 v2_x * helper_70 + v1_z * helper_81 + v2_z * helper_80 + v0_x * helper_68 + v1_x * helper_71 + helper_69 * v3_x;
	...
	const double helper_105 = 1.85037170770859e-17 * v0_z * helper_78 + 1.85037170770859e-17 * v0_y * helper_73 + 1.85037170770859e-17 * v1_y * helper_76 +
