...
void floatTetWild::AMIPS_hessian_v2( const std::array<double, 12>& arr, Matrix3& result_0 )
{
	...
	const double helper_5 = magic1 * helper_4;
	const double helper_6 = arr[ 3 ];
	const double helper_7 = magic2 * helper_6;
	const double helper_8 = arr[ 9 ];
	const double helper_9 = magic1 * helper_8;
	const double helper_10 = helper_5 - helper_7 + helper_9;
	const double helper_11 = arr[ 1 ];
	const double helper_12 = magic3 * helper_11;
	const double helper_13 = arr[ 4 ];
	const double helper_14 = magic3 * helper_13;
	const double helper_15 = arr[ 7 ];
	const double helper_16 = magic4 * helper_15;
	const double helper_17 = arr[ 10 ];
	const double helper_18 = magic3 * helper_17;
	const double helper_19 = helper_12 + helper_14 - helper_16 + helper_18;
	const double helper_20 = helper_10 * helper_19;
	const double helper_21 = magic1 * helper_11;
	const double helper_22 = magic2 * helper_13;
	const double helper_23 = magic1 * helper_17;
	const double helper_24 = helper_21 - helper_22 + helper_23;
	const double helper_25 = magic3 * helper_4;
	const double helper_26 = magic3 * helper_6;
	const double helper_27 = arr[ 6 ];
	const double helper_28 = magic4 * helper_27;
	const double helper_29 = magic3 * helper_8;
	...
	const double helper_34 = magic3 * helper_1;
	const double helper_35 = arr[ 5 ];
	const double helper_36 = magic3 * helper_35;
	const double helper_37 = arr[ 8 ];
	const double helper_38 = magic4 * helper_37;
	const double helper_39 = magic3 * helper_2;
	const double helper_40 = helper_34 + helper_36 - helper_38 + helper_39;
	const double helper_41 = helper_24 * helper_40;
	const double helper_42 = magic1 * helper_1;
	const double helper_43 = magic2 * helper_35;
	const double helper_44 = magic1 * helper_2;
	...
	const double helper_58 = magic5 * helper_13;
	const double helper_59 = magic5 * helper_15;
	const double helper_60 = helper_58 - helper_59;
	const double helper_61 = helper_3 * helper_60;
	const double helper_62 = magic5 * helper_35 - magic5 * helper_37;
	...
	const double helper_88 = magic5 * helper_6;
	const double helper_89 = magic5 * helper_27;
