...
namespace floatTetWild
{
	class MeshIO
	{
	  public:
		...
		static void write_mesh( const std::string& path, const Mesh& mesh, const std::vector<int>& t_ids, const bool do_filter = true, const bool binary = true,
		  const bool separate_components = false );
