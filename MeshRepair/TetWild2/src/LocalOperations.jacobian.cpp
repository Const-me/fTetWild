...
void floatTetWild::AMIPS_jacobian_v2( const std::array<Scalar, 12>& arr, Vector3& result_0 )
{
	...
	const double helper_7 = 0.577350269189626 * v0_x - 1.15470053837925 * v1_x + 0.577350269189626 * v3_x;
	const double helper_9 = 0.408248290463863 * v0_z;
	const double helper_11 = 0.408248290463863 * v1_z;
	const double helper_13 = 1.22474487139159 * v2_z;
	const double helper_15 = 0.408248290463863 * v3_z;
	const double helper_16 = helper_11 - helper_13 + helper_15 + helper_9;
	const double helper_17 = 0.577350269189626 * v0_z;
	const double helper_18 = 1.15470053837925 * v1_z;
	const double helper_19 = 0.577350269189626 * v3_z;
	const double helper_20 = helper_17 - helper_18 + helper_19;
	const double helper_22 = -1.22474487139159 * v2_x + 0.408248290463863 * v0_x + 0.408248290463863 * v1_x + 0.408248290463863 * v3_x;
	const double helper_23 = helper_16 * helper_7 - helper_20 * helper_22;
	const double helper_25 = 0.408248290463863 * v0_y;
	const double helper_27 = 0.408248290463863 * v1_y;
	const double helper_29 = 1.22474487139159 * v2_y;
	const double helper_30 = 0.408248290463863 * v3_y;
	const double helper_31 = helper_25 + helper_27 - helper_29 + helper_30;
	const double helper_32 = helper_31 * helper_7;
	const double helper_33 = 0.577350269189626 * v0_y;
	const double helper_34 = 1.15470053837925 * v1_y;
	const double helper_35 = 0.577350269189626 * v3_y;
	...
	const double helper_41 = 0.707106781186548 * v1_z - 0.707106781186548 * v2_z;
	const double helper_42 = 0.707106781186548 * v1_y - 0.707106781186548 * v2_y;
	...
	const double helper_46 = 0.666666666666667 *
							 ...
							 helper_39;
	const double helper_47 = -0.707106781186548 * v2_x + 0.707106781186548 * v1_x;
	result_0[ 0 ] = -helper_40 * ( v2_x - 3.0 * v0_x +
								   ...
								   v1_x + v3_x );
	result_0[ 1 ] =
	  helper_40 * ( 3.0 * v0_y - v3_y - v1_y - v2_y + helper_46 * ( helper_23 + helper_24 * helper_47 - helper_38 * helper_41 ) );
	result_0[ 2 ] = helper_40 * ( -v1_z - v2_z - v3_z +
								  helper_46 * ( -helper_3 * helper_47 - helper_32 + helper_37 + helper_38 * helper_42 ) + 3.0 * v0_z );
}
